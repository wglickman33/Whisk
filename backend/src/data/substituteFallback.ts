/** Keep this dataset here so Heroku (backend-only deploy) can resolve substitutes. */
import { SOURCING_NOTE_ANIMAL_DERIVED, type SubstituteOption } from "../utils/dietaryPreferences.js";
